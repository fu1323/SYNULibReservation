...
// 1. 使用 HttpUrl.Builder 自动处理参数编码
    ...
    public static int reservationCheck(Bean bean, String seatid, String cookie, String jobid, String oldtime, String trycount) throws IOException {
        Request request = new Request.Builder()
...
//                        return booking(300, bean, seatid, cookie, jobid, oldtime);
    ...
    public static int booking(int times, Bean bean, String seatid, String cookie, String jobid, String oldtime, String trycount) throws IOException {
        Request request = new Request.Builder()
